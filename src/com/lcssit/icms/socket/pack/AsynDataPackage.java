 ...
 * @author MxCc
 */
public class AsynDataPackage extends IDataPackage {

	public static final byte HEAD = 0x36, FOOT = 0x36;

	public AsynDataPackage(){
		this.setHead(AsynDataPackage.HEAD);
		this.setFoot(AsynDataPackage.FOOT);
	}
